...
# SNS Topics
SNS_AUTH_EVENTS_TOPIC_ARN = os.getenv('SNS_AUTH_EVENTS_TOPIC_ARN', SNS_TOPIC_ARN)
SNS_NOTIFICATION_TOPIC_ARN = os.getenv('SNS_NOTIFICATION_TOPIC_ARN', SNS_TOPIC_ARN)
